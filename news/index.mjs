...
}, co = () => !1, An = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && // uppercase letter
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), Mn = (e) => e.startsWith("onUpdate:"), Ae = Object.assign, Li = (e, t) => {
  const n = e.indexOf(t);
  n > -1 && e.splice(n, 1);
}, uo = Object.prototype.hasOwnProperty, W = (e, t) => uo.call(e, t), z = Array.isArray, kt = (e) => Zn(e) === "[object Map]", Jr = (e) => Zn(e) === "[object Set]", J = (e) => typeof e == "function", fe = (e) => typeof e == "string", wt = (e) => typeof e == "symbol", ie = (e) => e !== null && typeof e == "object", Oi = (e) => (ie(e) || J(e)) && J(e.then) && J(e.catch), Qr = Object.prototype.toString, Zn = (e) => Qr.call(e), Ri = (e) => Zn(e).slice(8, -1), Yr = (e) => Zn(e) === "[object Object]", Hi = (e) => fe(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, _t = /* @__PURE__ */ ut(
...
function mo(e) {
  const t = {};
  return e.replace(Eo, "").split(ho).forEach((n) => {
    if (n) {
      const i = n.split(vo);
...
} : wt(t) ? ii(t) : ie(t) && !z(t) && !Yr(t) ? String(t) : t, ii = (e, t = "") => {
  var n;
  return (
...
function _r(e) {
  ...
  for (; i; ) {
    const r = i.prevDep;
    i.version === -1 ? (i === n && (n = r), ji(i), Mo(i)) : t = i, i.dep.activeLink = i.prevActiveLink, i.prevActiveLink = void 0, i = r;
  }
...
class Xi {
  ...
  track(t) {
    ...
    if (n === void 0 || n.sub !== _)
      n = this.activeLink = new So(_, this), _.deps ? (n.prevDep = _.depsTail, _.depsTail.nextDep = n, _.depsTail = n) : _.deps = _.depsTail = n, ts(n);
...
const Oo = /* @__PURE__ */ ut("__proto__,__v_isRef,__isVue"), ns = new Set(
...
class is {
  ...
  get(t, n, i) {
    ...
    if (n === "__v_isShallow")
      return s;
    if (n === "__v_raw")
      return i === (r ? s ? cs : ls : s ? fs : os).get(t) || // receiver is not the reactive proxy, but has the same prototype
    ...
    return (wt(n) ? ns.has(n) : Oo(n)) || (r || pe(t, "get", n), s) ? f : ue(f) ? o && Hi(n) ? f : f.value : ie(f) ? r ? us(f) : Ji(f) : f;
  }
}
class rs extends is {
  constructor(t = !1) {
  ...
  has(t, n) {
    ...
    return (!wt(n) || !ns.has(n)) && pe(t, "has", n), i;
  }
  ownKeys(t) {
    return pe(
      t,
...
const Ho = /* @__PURE__ */ new rs(), To = /* @__PURE__ */ new ss(), zo = /* @__PURE__ */ new rs(!0), jo = /* @__PURE__ */ new ss(!0), Ei = (e) => e, vn = (e) => Reflect.getPrototypeOf(e);
function Xo(e, t, n) {
  return function(...i) {
...
const os = /* @__PURE__ */ new WeakMap(), fs = /* @__PURE__ */ new WeakMap(), ls = /* @__PURE__ */ new WeakMap(), cs = /* @__PURE__ */ new WeakMap();
function Fo(e) {
  switch (e) {
    case "Object":
    case "Array":
...
function Vo(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : Fo(Ri(e));
}
function Ji(e) {
  return ct(e) ? e : Kn(
    e,
...
const ye = (e) => ie(e) ? Ji(e) : e, mi = (e) => ie(e) ? us(e) : e;
function ue(e) {
...
function tf(e, t, n = ee) {
  ...
  return f && f(K), l = new Wr(p), l.scheduler = o ? () => o(K, !1) : K, P = (k) => ef(k, !1, l), h = l.onStop = () => {
    const k = Ln.get(l);
    if (k) {
      if (u)
        u(k, 4);
...
function N(e, ...t) {
  ...
  const n = Rt.length ? Rt[Rt.length - 1].component : null, i = n && n.appContext.config.warnHandler, r = nf();
  if (i)
    Zt(
      i,
      n,
...
function ds(e, t, n) {
  return fe(t) ? (t = JSON.stringify(t), n ? t : [`${e}=${t}`]) : typeof t == "number" || typeof t == "boolean" || t == null ? n ? t : [`${e}=${t}`] : ue(t) ? (t = ds(e, Z(t.value), !0), n ? t : [`${e}=Ref<`, t, ">"]) : J(t) ? [`${e}=fn${t.name ? `<${t.name}>` : ""}`] : (t = Z(t), n ? t : [`${e}=`, t]);
}
const Qi = {
...
function qn(e) {
  if (!(e.flags & 1)) {
    ...
    !(e.flags & 2) && t >= fn(n) ? De.push(e) : De.splice(cf(t), 0, e), e.flags |= 1, gs();
  }
}
function gs() {
  On || (On = ps.then(Es));
...
function hs(e) {
  z(e) ? Jt.push(...e) : ht && e.id === -1 ? ht.splice(jt + 1, 0, e) : e.flags & 1 || (Jt.push(e), e.flags |= 1), gs();
}
...
function Es(e) {
  ...
  try {
    ...
    We = -1, De.length = 0, vs(e), On = null, (De.length || Jt.length) && Es(e);
  }
}
function Yi(e, t) {
  const n = e.get(t) || 0;
  if (n > lf) {
    const i = t.i, r = i && _s(i.type);
    return dn(
...
function uf(e) {
  ...
  let n = Tt.get(t);
  n || (ms(t, e.type), n = Tt.get(t)), n.instances.add(e);
}
function Af(e) {
...
function Hn(e) {
  const t = Oe;
  return Oe = e, Ps = e && e.type.__scopeId || null, t;
}
function yf(e, t = Oe, n) {
  if (!t || e._n)
    return e;
  const i = (...r) => {
    i._d && br(-1);
    ...
    return {}.NODE_ENV !== "production" && bs(t), o;
  };
...
const Pf = Symbol("_vte"), wf = (e) => e.__isTeleport;
function Gi(e, t) {
...
function xs(e, t, n = he) {
  ...
  if (_n(t, i, n), n) {
    let r = n.parent;
    for (; r && r.parent; )
      Fi(r.parent.vnode) && Nf(i, t, n, r), r = r.parent;
  }
}
function Nf(e, t, n, i) {
  const r = _n(
...
const bi = (e) => e ? Us(e) ? $i(e) : bi(e.parent) : null, Ht = (
...
), Vi = (e) => e === "_" || e === "$", ci = (e, t) => e !== ee && !e.__isScriptSetup && W(e, t), Ns = {
  get({ _: e }, t) {
    if (t === "__v_skip")
      return !0;
...
({}).NODE_ENV !== "production" && (Ns.ownKeys = (e) => (N(
...
function Qf(e) {
  ...
  const {
    ...
    directives: Ct,
    filters: X
  } = t, S = {}.NODE_ENV !== "production" ? Jf() : null;
  if ({}.NODE_ENV !== "production") {
  ...
  if (C(Bf, l), C($n, p), C(Mf, h), C(Sf, P), C(xf, E), C(Df, R), C(Hf, le), C(Rf, q), C(Of, de), C(kf, G), C(Ds, K), C(Lf, oe), z(te))
    if (te.length) {
      ...
      e.exposed || (e.exposed = {});
  k && e.render === ge && (e.render = k), F != null && (e.inheritAttrs = F), me && (e.components = me), Ct && (e.directives = Ct), oe && Cs(e);
}
...
function Wf(e, t) {
  return function(i, r = null) {
    ...
    const s = Ms(), o = /* @__PURE__ */ new WeakSet(), f = [];
    let u = !1;
    const d = s.app = {
      _uid: Vf++,
      _component: i,
      ...
      directive(a, l) {
        return {}.NODE_ENV !== "production" && ws(a), l ? ({}.NODE_ENV !== "production" && s.directives[a] && N(`Directive "${a}" has already been registered in target app.`), s.directives[a] = l, d) : s.directives[a];
      },
      mount(a, l, p) {
        if (u)
          ({}).NODE_ENV !== "production" && N(
          ...
          }), l && t ? t(h, a) : e(h, a, p), u = !0, d._container = a, a.__vue_app__ = d, {}.NODE_ENV !== "production" && (d._instance = h.component, pf(d, Cr)), $i(h.component);
        }
      },
      onUnmount(a) {
      ...
      unmount() {
        u ? (tt(
          ...
          d._instance,
          16
        ), e(null, d._container), {}.NODE_ENV !== "production" && (d._instance = null, gf(d)), delete d._container.__vue_app__) : {}.NODE_ENV !== "production" && N("Cannot unmount an app that is not mounted.");
      },
      provide(a, l) {
...
const Ss = {}, ks = () => Object.create(Ss), Ls = (e) => Object.getPrototypeOf(e) === Ss;
function Uf(e, t, n, i = !1) {
  const r = {}, s = ks();
  e.propsDefaults = /* @__PURE__ */ Object.create(null), Os(e, t, r, s);
  for (const o in e.propsOptions[0])
    o in r || (r[o] = void 0);
  ({}).NODE_ENV !== "production" && Hs(t || {}, r, e), n ? e.props = i ? r : Wo(r) : e.type.props ? e.props = r : e.props = s, e.attrs = s;
}
function qf(e) {
  for (; e; ) {
    if (e.type.__hmrId)
...
function _f(e, t, n, i) {
  ...
  if (
    ...
    !({}.NODE_ENV !== "production" && qf(e)) && (i || o > 0) && !(o & 16)
  ) {
    if (o & 8) {
  ...
  d && Ue(e.attrs, "set", ""), {}.NODE_ENV !== "production" && Hs(t || {}, r, e);
}
function Os(e, t, n, i) {
...
function Rs(e, t, n = !1) {
  const i = n ? $f : t.propsCache, r = i.get(e);
  if (r)
    return r;
  const s = e.props, o = {}, f = [];
  let u = !1;
  ...
  if (!(t == null && !o)) {
    if (s != null && s !== !0 && !u) {
      ...
      for (let p = 0; p < a.length && !d; p++) {
        const { valid: h, expectedType: P } = il(t, a[p]);
        l.push(P || ""), d = h;
      }
      if (!d) {
        N(rl(e, t, l));
...
function rl(e, t, n) {
  ...
  return n.length === 1 && vr(r) && !sl(r, s) && (i += ` with value ${o}`), i += `, got ${s} `, vr(s) && (i += `with value ${f}.`), i;
}
function hr(e, t) {
...
const Ts = (e) => e[0] === "_" || e === "$stable", Ki = (e) => z(e) ? e.map(Je) : [Je(e)], ol = (e, t, n) => {
  if (t._n)
    return t;
  const i = yf((...r) => ({}.NODE_ENV !== "production" && he && (!n || n.root === he.root) && N(
  ...
  if (e.vnode.shapeFlag & 32) {
    const r = t._;
    r ? (Ci(i, t, n), n && Sn(i, "_", r, !0)) : zs(t, i);
  } else
    t && js(e, t);
}, ll = (e, t, n) => {
  ...
  if (i.shapeFlag & 32) {
    const f = t._;
    f ? {}.NODE_ENV !== "production" && $e ? (Ci(r, t, n), Ue(e, "set", "$slots")) : n && f === 1 ? s = !1 : Ci(r, t, n) : (s = !t.$stable, zs(t, r)), o = t;
  } else
    t && (js(e, t), o = { default: 1 });
  if (s)
    for (const f in r)
      !Ts(f) && o[f] == null && delete r[f];
};
let Wt, mt;
function rt(e, t) {
  e.appContext.config.performance && Xn() && mt.mark(`vue-${t}-${e.uid}`), {}.NODE_ENV !== "production" && mf(e, t, Xn() ? mt.now() : Date.now());
}
function st(e, t) {
  ...
  ({}).NODE_ENV !== "production" && If(e, t, Xn() ? mt.now() : Date.now());
}
function Xn() {
...
function Al(e, t) {
  cl();
  const n = an();
  n.__VUE__ = !0, {}.NODE_ENV !== "production" && Is(n.__VUE_DEVTOOLS_GLOBAL_HOOK__, n);
  const {
    insert: i,
    remove: r,
    patchProp: s,
    ...
    if (v) {
      let I = v.subTree;
      if ({}.NODE_ENV !== "production" && I.patchFlag > 0 && I.patchFlag & 2048 && (I = Ui(I.children) || I), A === I || Gs(I.type) && (I.ssContent === A || I.ssFallback === A)) {
        const B = v.vnode;
        le(
          c,
          B,
    ...
    const D = c.component = Sl(
      c,
      b,
      v
    );
    if ({}.NODE_ENV !== "production" && D.type.__hmrId && uf(D), {}.NODE_ENV !== "production" && (In(c), rt(D, "mount")), Fi(c) && (D.ctx.renderer = Pe), {}.NODE_ENV !== "production" && rt(D, "init"), Ll(D, !1, B), {}.NODE_ENV !== "production" && st(D, "init"), D.asyncDep) {
    ...
    const D = () => {
      if (c.isMounted) {
        ...
        c.subTree = Ie, {}.NODE_ENV !== "production" && rt(c, "patch"), E(
          ...
          v,
          I
        ), {}.NODE_ENV !== "production" && st(c, "patch"), M.el = Ie.el, $ === null && yl(c, Ie.el), Y && Le(Y, v), (Se = M.props && M.props.onVnodeUpdated) && Le(
          () => Ve(Se, V, M, se),
          v
        ), {}.NODE_ENV !== "production" && bs(c), {}.NODE_ENV !== "production" && bn();
      } else {
        let M;
        ...
        (A.shapeFlag & 256 || $ && tn($.vnode) && $.vnode.shapeFlag & 256) && c.a && Le(c.a, v), c.isMounted = !0, {}.NODE_ENV !== "production" && hf(c), A = g = b = null;
      }
    };
    c.scope.on();
    const x = c.effect = new Wr(D);
    c.scope.off();
    ...
    c.vnode = A, c.next = null, _f(c, A.props, b, g), ll(c, A.children, g), At(), cr(c), at();
    ...
    Er(x), Er(y), b && Ft(b), v.stop(), I && (I.flags |= 8, re(B, c, A, g)), D && Le(D, A), Le(() => {
      c.isUnmounted = !0;
    }, A), A && A.pendingBranch && !A.isUnmounted && c.asyncDep && !c.asyncResolved && c.suspenseId === A.pendingId && (A.deps--, A.deps === 0 && A.resolve()), {}.NODE_ENV !== "production" && Ef(c);
    ...
    const A = p(c.anchor || c.el), g = A && A[Pf];
    return g ? p(g) : A;
  };
  let je = !1;
  const ve = (c, A, g) => {
...
function hl(e, t, n) {
  const i = this.proxy, r = fe(e) ? e.includes(".") ? Qs(i, e) : () => i[e] : e.bind(i, i);
  let s;
  J(t) ? s = t : (s = t.handler, n = t);
  const o = hn(this), f = Js(r, s.bind(i), n);
  return o(), f;
}
function Qs(e, t) {
  const n = t.split(".");
...
const vl = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${Qe(t)}Modifiers`] || e[`${yt(t)}Modifiers`];
function El(e, t, ...n) {
  if (e.isUnmounted)
    return;
  ...
  let r = n;
  const s = t.startsWith("update:"), o = s && vl(i, t.slice(7));
  if (o && (o.trim && (r = n.map((a) => fe(a) ? a.trim() : a)), o.number && (r = n.map(go))), {}.NODE_ENV !== "production" && bf(e, t, r), {}.NODE_ENV !== "production") {
...
function Ai(e) {
  ...
  let T = L, K;
  if ({}.NODE_ENV !== "production" && L.patchFlag > 0 && L.patchFlag & 2048 && ([T, K] = Zs(L)), G && E !== !1) {
...
function Fs(e) {
  return e.dynamicChildren = ln > 0 ? Re || Xt : null, wl(), ln > 0 && Re && Re.push(e), e;
}
...
const Te = {}.NODE_ENV !== "production" ? Cl : Ws;
function Ws(e, t = null, n = null, i = 0, r = null, s = !1) {
  if ((!e || e === Tf) && ({}.NODE_ENV !== "production" && !e && N(`Invalid vnode type when creating vnode: ${e}.`), e = He), ti(e)) {
    const f = Pt(
      e,
      t,
      !0
  ...
  const o = fe(e) ? 1 : Gs(e) ? 128 : wf(e) ? 64 : ie(e) ? 4 : J(e) ? 2 : 0;
...
function xl(e) {
  return e ? kn(e) || Ls(e) ? Ae({}, e) : e : null;
}
function Pt(e, t, n = !1, i = !1) {
  const { props: r, ref: s, patchFlag: o, children: f, transition: u } = e, d = t ? Nl(r || {}, t) : r, a = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e.type,
    props: d,
    ...
    children: {}.NODE_ENV !== "production" && o === -1 && z(f) ? f.map(Ks) : f,
    target: e.target,
...
function Ks(e) {
  const t = Pt(e);
  return z(e.children) && (t.children = e.children.map(Ks)), t;
}
function Dl(e = " ", t = 0) {
...
function qi(e, t) {
  ...
  if (t == null)
    ...
    if (i & 65) {
      ...
      n = 32;
      const r = t._;
      !r && !Ls(t) ? t._ctx = Oe : r === 3 && Oe && (Oe.slots._ === 1 ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024));
    }
  else
    J(t) ? (t = { default: t, _ctx: Oe }, n = 32) : (t = String(t), i & 64 ? (n = 16, t = [Dl(t)]) : n = 8);
...
let Ml = 0;
function Sl(e, t, n) {
  const i = e.type, r = (t ? t.appContext : e.appContext) || Bl, s = {
    uid: Ml++,
    vnode: e,
    type: i,
    parent: t,
  ...
  return {}.NODE_ENV !== "production" ? s.ctx = zf(s) : s.ctx = { _: s }, s.root = t ? t.root : s, s.emit = El.bind(null, s), e.ce && e.ce(s), s;
}
let he = null;
const _i = () => he || Oe;
let Qn, Di;
...
function Ll(e, t = !1, n = !1) {
  t && Di(t);
  const { props: i, children: r } = e.vnode, s = Us(e);
  Uf(e, i, s, t), fl(e, r, n);
  const o = s ? Ol(e, t) : void 0;
  return t && Di(!1), o;
}
function Ol(e, t) {
  var n;
  ...
  if ({}.NODE_ENV !== "production") {
    ...
    i.compilerOptions && Rl() && N(
      '"compilerOptions" is only supported when using a build of Vue that includes the runtime compiler. Since you are using a runtime-only build, the options should be passed via your build tool config instead.'
    );
  }
  e.accessCache = /* @__PURE__ */ Object.create(null), e.proxy = new Proxy(e.ctx, Ns), {}.NODE_ENV !== "production" && jf(e);
  const { setup: r } = i;
  if (r) {
    At();
    const s = e.setupContext = r.length > 1 ? Tl(e) : null, o = hn(e), f = Zt(
      r,
      e,
      0,
      [
...
function Pr(e, t, n) {
  ...
  ), {}.NODE_ENV !== "production" && (e.devtoolsRawSetupState = t), e.setupState = as(t), {}.NODE_ENV !== "production" && Xf(e)) : {}.NODE_ENV !== "production" && t !== void 0 && N(
...
function $i(e) {
  return e.exposed ? e.exposeProxy || (e.exposeProxy = new Proxy(as(Ko(e.exposed)), {
    get(t, n) {
      if (n in t)
        return t[n];
      if (n in Ht)
...
const eo = Mi ? (e) => Mi.createHTML(e) : (e) => e, Jl = "http://www.w3.org/2000/svg", Ql = "http://www.w3.org/1998/Math/MathML", ot = typeof document < "u" ? document : null, Dr = ot && /* @__PURE__ */ ot.createElement("template"), Yl = {
  insert: (e, t, n) => {
  ...
  createElement: (e, t, n, i) => {
    const r = t === "svg" ? ot.createElementNS(Jl, e) : t === "mathml" ? ot.createElementNS(Ql, e) : n ? ot.createElement(e, { is: n }) : ot.createElement(e);
...
const Nr = Symbol("_vod"), Fl = Symbol("_vsh"), Vl = Symbol({}.NODE_ENV !== "production" ? "CSS_VAR_TEXT" : ""), Wl = /(^|;)\s*display\s*:/;
function Kl(e, t, n) {
  ...
  if (n && !r) {
    ...
    if (t !== n) {
      const o = i[Vl];
      o && (n += ";" + o), i.cssText = n, s = Wl.test(n);
    }
  } else
    t && e.removeAttribute("style");
  Nr in e && (e[Nr] = s ? i.display : "", e[Fl] && (i.display = "none"));
}
const Ul = /[^\\];\s*$/, Br = /\s*!important$/;
function Nn(e, t, n) {
  if (z(n))
    n.forEach((i) => Nn(e, t, i));
  else if (n == null && (n = ""), {}.NODE_ENV !== "production" && Ul.test(n) && lt(
...
function kr(e, t, n, i, r, s = Do(t)) {
  i && t.startsWith("xlink:") ? n == null ? e.removeAttributeNS(Sr, t.slice(6, t.length)) : e.setAttributeNS(Sr, t, n) : n == null || s && !Zr(n) ? e.removeAttribute(t) : e.setAttribute(
    t,
    s ? "" : wt(n) ? String(n) : n
  );
}
function Lr(e, t, n, i, r) {
  ...
  if (n === "" || n == null) {
    const f = typeof e[t];
    f === "boolean" ? n = Zr(n) : n == null && f === "string" ? (n = "", o = !0) : f === "number" && (n = 0, o = !0);
  }
  try {
    e[t] = n;
  } catch (f) {
...
let di = 0;
const nc = /* @__PURE__ */ Promise.resolve(), ic = () => di || (nc.then(() => di = 0), di = Date.now());
function rc(e, t) {
  const n = (i) => {
    if (!i._vts)
      i._vts = Date.now();
...
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, oc = (e, t, n, i, r, s) => {
  const o = r === "svg";
  t === "class" ? Gl(e, i, o) : t === "style" ? Kl(e, n, i) : An(t) ? Mn(t) || ec(e, t, n, i, s) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : fc(e, t, i, o)) ? (Lr(e, t, i), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && kr(e, t, i, o, s, t !== "value")) : /* #11081 force set props for possible async custom element */ e._isVueCE && (/[A-Z]/.test(t) || !fe(i)) ? Lr(e, Qe(t), i, s, t) : (t === "true-value" ? e._trueValue = i : t === "false-value" && (e._falseValue = i), kr(e, t, i, o));
};
function fc(e, t, n, i) {
  if (i)
...
const lc = /* @__PURE__ */ Ae({ patchProp: oc }, Yl);
let zr;
function cc() {
  return zr || (zr = ul(lc));
}
...
const vc = Object.prototype.toString, Ec = (e) => vc.call(e) === "[object Object]", mc = () => {
};
function Ic(e) {
  return e || _i();
}
...
function Cc(e, t, n = {}) {
  ...
  let s;
  const o = wc(() => i && "ResizeObserver" in i), f = () => {
...
function xc(e, t = { width: 0, height: 0 }, n = {}) {
...
kc();
const oo = jc(), Oc = `https://api.taboola.com/2.0/json/maxthonbrowser-${oo}/recommendations.get`;
async function Rc(e = {}) {
  const t = Hc(e), i = await (await fetch(Oc, {
    method: "post",
    credentials: "include",
...
function Tc(e, t) {
  const n = e.pn || Nc("pn"), i = e.length || 9;
...
function Xc() {
  ...
  return e || (e = Dc(), localStorage.setItem("mx-deviceId", e)), e;
}
const fo = {
  // 获取新闻：参数见 README.md
  getNewsList(e = {}) {
...
const Vc = ["src", "data-src"], Wc = {
  ...
  setup(e) {
    const t = e, { isLoading: n, error: i } = Gc({ src: t.src }), r = ze(() => n.value ? t.placeholder : i.value ? t.error : t.src), s = ze(() => ({
      width: t.width,
...
const Kc = ["href"], Uc = { class: "mx-news-content" }, qc = ["innerHTML"], _c = { class: "mx-news-source" }, $c = { class: "mx-news-date" }, Xr = {
  __name: "MxNewsItem",
  props: {
    // 数据
  ...
  setup(e) {
    ...
    return $n(() => {
      const s = new IntersectionObserver(
        (o) => {
          o.forEach((f) => {
            f.isIntersecting && (fo.setNewsVisible(t.data.visibleUrl), s.disconnect());
          });
        },
        { threshold: 0.5 }
      );
      ...
      Ke("div", Uc, [
        ...
        Ke("div", {
          ...
          Ke("span", _c, pi(e.data.tag), 1),
          o[0] || (o[0] = Ke("span", null, "·", -1)),
          Ke("span", $c, pi(e.data.date), 1)
        ], 2)
      ]),
      Ke("div", {
        class: "mx-news-imgs",
        ...
        (ce(!0), be(Ee, null, zn(n.value, (f) => (ce(), cn(Wc, {
          key: f,
          src: f,
          "aspect-ratio": "16/9"
        }, null, 8, ["src"]))), 128))
...
const eu = { class: "mx-news-list" }, tu = {
  key: 0,
  class: "mx-mt-10"
}, nu = {
  key: 1,
  ...
  setup(e) {
    const t = e, n = document.querySelector(t.container), i = t.scrollbar ? document.querySelector(t.scrollbar) : document, r = t.scrollbar ? document.querySelector(t.scrollbar) : document.documentElement, { width: s } = xc(n), o = ze(() => t.autoCols && s.value >= 768), f = et(null), u = ze(() => t.needTop && f.value ? f.value[0] : null), d = ze(() => {
      var E, R;
    ...
    return p(!0), (P, E) => (ce(), be("div", eu, [
      f.value ? f.value.length ? (ce(), be(Ee, { key: 2 }, [
        ...
        Ke("div", {
          ...
          (ce(!0), be(Ee, null, zn(d.value, (R, L) => (ce(), cn(Xr, {
            key: L,
            data: R,
            "is-top": !1
          }, null, 8, ["data"]))), 128))
        ], 2),
        a.value ? (ce(), be("div", iu, " Loading... ")) : Dn("", !0)
      ], 64)) : (ce(), be("div", nu, " No Data ")) : (ce(), be("div", tu, [
...
function ru(e = {}) {
  const t = uc(lo, e), n = document.querySelector(e.container);
  return t.mount(n), {
    destroy() {
