...
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), Mn = (e) => e.startsWith("onUpdate:"), Ae = Object.assign, Li = (e, t) => {
  const n = e.indexOf(t);
  n > -1 && e.splice(n, 1);
}, po = Object.prototype.hasOwnProperty, W = (e, t) => po.call(e, t), z = Array.isArray, kt = (e) => Zn(e) === "[object Map]", Yr = (e) => Zn(e) === "[object Set]", J = (e) => typeof e == "function", fe = (e) => typeof e == "string", wt = (e) => typeof e == "symbol", ie = (e) => e !== null && typeof e == "object", Oi = (e) => (ie(e) || J(e)) && J(e.then) && J(e.catch), Zr = Object.prototype.toString, Zn = (e) => Zr.call(e), Ri = (e) => Zn(e).slice(8, -1), Gr = (e) => Zn(e) === "[object Object]", Hi = (e) => fe(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, _t = /* @__PURE__ */ ut(
...
function yo(e) {
  const t = {};
  return e.replace(bo, "").split(mo).forEach((n) => {
    if (n) {
      const i = n.split(Io);
...
const Po = "html,body,base,head,link,meta,style,title,address,article,aside,footer,header,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot", wo = "svg,animate,animateMotion,animateTransform,circle,clipPath,color-profile,defs,desc,discard,ellipse,feBlend,feColorMatrix,feComponentTransfer,feComposite,feConvolveMatrix,feDiffuseLighting,feDisplacementMap,feDistantLight,feDropShadow,feFlood,feFuncA,feFuncB,feFuncG,feFuncR,feGaussianBlur,feImage,feMerge,feMergeNode,feMorphology,feOffset,fePointLight,feSpecularLighting,feSpotLight,feTile,feTurbulence,filter,foreignObject,g,hatch,hatchpath,image,line,linearGradient,marker,mask,mesh,meshgradient,meshpatch,meshrow,metadata,mpath,path,pattern,polygon,polyline,radialGradient,rect,set,solidcolor,stop,switch,symbol,text,textPath,title,tspan,unknown,use,view", Co = "annotation,annotation-xml,maction,maligngroup,malignmark,math,menclose,merror,mfenced,mfrac,mfraction,mglyph,mi,mlabeledtr,mlongdiv,mmultiscripts,mn,mo,mover,mpadded,mphantom,mprescripts,mroot,mrow,ms,mscarries,mscarry,msgroup,msline,mspace,msqrt,msrow,mstack,mstyle,msub,msubsup,msup,mtable,mtd,mtext,mtr,munder,munderover,none,semantics", xo = /* @__PURE__ */ ut(Po), Do = /* @__PURE__ */ ut(wo), No = /* @__PURE__ */ ut(Co), Bo = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly", Mo = /* @__PURE__ */ ut(Bo);
function Fr(e) {
  return !!e || e === "";
}
const Vr = (e) => !!(e && e.__v_isRef === !0), pi = (e) => fe(e) ? e : e == null ? "" : z(e) || ie(e) && (e.toString === Zr || !J(e.toString)) ? Vr(e) ? pi(e.value) : JSON.stringify(e, Wr, 2) : String(e), Wr = (e, t) => Vr(t) ? Wr(e, t.value) : kt(t) ? {
...
function es(e) {
  ...
  for (; i; ) {
    const r = i.prevDep;
    i.version === -1 ? (i === n && (n = r), ji(i), Lo(i)) : t = i, i.dep.activeLink = i.prevActiveLink, i.prevActiveLink = void 0, i = r;
  }
...
class Xi {
  ...
  track(t) {
    ...
    if (n === void 0 || n.sub !== _)
      n = this.activeLink = new Oo(_, this), _.deps ? (n.prevDep = _.depsTail, _.depsTail.nextDep = n, _.depsTail = n) : _.deps = _.depsTail = n, is(n);
...
const To = /* @__PURE__ */ ut("__proto__,__v_isRef,__isVue"), rs = new Set(
...
class ss {
  ...
  get(t, n, i) {
    ...
    return (wt(n) ? rs.has(n) : To(n)) || (r || pe(t, "get", n), s) ? f : ue(f) ? o && Hi(n) ? f : f.value : ie(f) ? r ? as(f) : Ji(f) : f;
  }
}
class os extends ss {
  constructor(t = !1) {
...
const jo = /* @__PURE__ */ new os(), Xo = /* @__PURE__ */ new fs(), Jo = /* @__PURE__ */ new os(!0), Qo = /* @__PURE__ */ new fs(!0), Ei = (e) => e, vn = (e) => Reflect.getPrototypeOf(e);
function Yo(e, t, n) {
  return function(...i) {
...
function Uo(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : Ko(Ri(e));
}
function Ji(e) {
  return ct(e) ? e : Kn(
    e,
...
function sf(e, t, n = ee) {
  ...
  return f && f(K), l = new Ur(p), l.scheduler = o ? () => o(K, !1) : K, P = (k) => rf(k, !1, l), h = l.onStop = () => {
    const k = Ln.get(l);
    if (k) {
      if (u)
        u(k, 4);
...
function N(e, ...t) {
  ...
  const n = Rt.length ? Rt[Rt.length - 1].component : null, i = n && n.appContext.config.warnHandler, r = of();
  if (i)
    Zt(
      i,
      n,
...
function gs(e, t, n) {
  return fe(t) ? (t = JSON.stringify(t), n ? t : [`${e}=${t}`]) : typeof t == "number" || typeof t == "boolean" || t == null ? n ? t : [`${e}=${t}`] : ue(t) ? (t = gs(e, Z(t.value), !0), n ? t : [`${e}=Ref<`, t, ">"]) : J(t) ? [`${e}=fn${t.name ? `<${t.name}>` : ""}`] : (t = Z(t), n ? t : [`${e}=`, t]);
}
const Qi = {
...
function Es(e) {
  z(e) ? Jt.push(...e) : ht && e.id === -1 ? ht.splice(jt + 1, 0, e) : e.flags & 1 || (Jt.push(e), e.flags |= 1), vs();
}
...
function Is(e) {
  ...
  try {
    ...
    We = -1, De.length = 0, ms(e), On = null, (De.length || Jt.length) && Is(e);
  }
}
function Yi(e, t) {
  const n = e.get(t) || 0;
...
function xs(e) {
  go(e) && N("Do not use built-in directive ids as custom directive id: " + e);
}
function xt(e, t, n, i) {
...
const xf = Symbol("_vte"), Df = (e) => e.__isTeleport;
function Gi(e, t) {
...
function Ns(e, t, n = he) {
  ...
  if (_n(t, i, n), n) {
    let r = n.parent;
    for (; r && r.parent; )
      Fi(r.parent.vnode) && Sf(i, t, n, r), r = r.parent;
  }
}
function Sf(e, t, n, i) {
  const r = _n(
...
const bi = (e) => e ? _s(e) ? $i(e) : bi(e.parent) : null, Ht = (
...
), Vi = (e) => e === "_" || e === "$", ci = (e, t) => e !== ee && !e.__isScriptSetup && W(e, t), Ms = {
  get({ _: e }, t) {
    if (t === "__v_skip")
      return !0;
...
function Gf(e) {
  ...
  const {
    ...
    directives: Ct,
    filters: X
  } = t, S = {}.NODE_ENV !== "production" ? Zf() : null;
  if ({}.NODE_ENV !== "production") {
  ...
  if (C(kf, l), C($n, p), C(Lf, h), C(Of, P), C(Bf, E), C(Mf, R), C(jf, le), C(zf, q), C(Tf, de), C(Rf, G), C(Bs, K), C(Hf, oe), z(te))
    if (te.length) {
    ...
    const d = s.app = {
      ...
      mount(a, l, p) {
        if (u)
          ...
          }), l && t ? t(h, a) : e(h, a, p), u = !0, d._container = a, a.__vue_app__ = d, {}.NODE_ENV !== "production" && (d._instance = h.component, vf(d, xr)), $i(h.component);
        }
      },
      onUnmount(a) {
      ...
      unmount() {
        u ? (tt(
          ...
          d._instance,
          16
        ), e(null, d._container), {}.NODE_ENV !== "production" && (d._instance = null, Ef(d)), delete d._container.__vue_app__) : {}.NODE_ENV !== "production" && N("Cannot unmount an app that is not mounted.");
      },
      provide(a, l) {
...
function $f(e, t, n, i = !1) {
  ...
  for (const o in e.propsOptions[0])
    o in r || (r[o] = void 0);
  ({}).NODE_ENV !== "production" && zs(t || {}, r, e), n ? e.props = i ? r : qo(r) : e.type.props ? e.props = r : e.props = s, e.attrs = s;
}
function el(e) {
  for (; e; ) {
    if (e.type.__hmrId)
...
function tl(e, t, n, i) {
  ...
  if (
    ...
    !({}.NODE_ENV !== "production" && el(e)) && (i || o > 0) && !(o & 16)
  ) {
    if (o & 8) {
...
function Ts(e, t, n = !1) {
  const i = n ? nl : t.propsCache, r = i.get(e);
  if (r)
    return r;
  const s = e.props, o = {}, f = [];
  let u = !1;
  ...
  if (!(t == null && !o)) {
    if (s != null && s !== !0 && !u) {
      ...
      for (let p = 0; p < a.length && !d; p++) {
        const { valid: h, expectedType: P } = ol(t, a[p]);
        l.push(P || ""), d = h;
      }
      if (!d) {
        N(fl(e, t, l));
...
function fl(e, t, n) {
  ...
  return n.length === 1 && Er(r) && !ll(r, s) && (i += ` with value ${o}`), i += `, got ${s} `, Er(s) && (i += `with value ${f}.`), i;
}
function vr(e, t) {
...
const js = (e) => e[0] === "_" || e === "$stable", Ki = (e) => z(e) ? e.map(Je) : [Je(e)], cl = (e, t, n) => {
  if (t._n)
    return t;
  const i = Cf((...r) => ({}.NODE_ENV !== "production" && he && (!n || n.root === he.root) && N(
...
let Wt, mt;
function rt(e, t) {
  e.appContext.config.performance && Xn() && mt.mark(`vue-${t}-${e.uid}`), {}.NODE_ENV !== "production" && yf(e, t, Xn() ? mt.now() : Date.now());
}
function st(e, t) {
  ...
  ({}).NODE_ENV !== "production" && Pf(e, t, Xn() ? mt.now() : Date.now());
}
function Xn() {
...
function pl(e, t) {
  ...
  const {
    ...
    if (v) {
      let I = v.subTree;
      if ({}.NODE_ENV !== "production" && I.patchFlag > 0 && I.patchFlag & 2048 && (I = Ui(I.children) || I), A === I || Vs(I.type) && (I.ssContent === A || I.ssFallback === A)) {
        const B = v.vnode;
        le(
          c,
          B,
    ...
    const D = c.component = Ol(
      c,
      b,
      v
    );
    if ({}.NODE_ENV !== "production" && D.type.__hmrId && df(D), {}.NODE_ENV !== "production" && (In(c), rt(D, "mount")), Fi(c) && (D.ctx.renderer = Pe), {}.NODE_ENV !== "production" && rt(D, "init"), Hl(D, !1, B), {}.NODE_ENV !== "production" && st(D, "init"), D.asyncDep) {
    ...
    const D = () => {
      if (c.isMounted) {
        ...
        c.subTree = Ie, {}.NODE_ENV !== "production" && rt(c, "patch"), E(
          ...
          v,
          I
        ), {}.NODE_ENV !== "production" && st(c, "patch"), M.el = Ie.el, $ === null && Cl(c, Ie.el), Y && Le(Y, v), (Se = M.props && M.props.onVnodeUpdated) && Le(
          () => Ve(Se, V, M, se),
          v
        ...
        (A.shapeFlag & 256 || $ && tn($.vnode) && $.vnode.shapeFlag & 256) && c.a && Le(c.a, v), c.isMounted = !0, {}.NODE_ENV !== "production" && mf(c), A = g = b = null;
      }
    };
    c.scope.on();
    ...
    c.vnode = A, c.next = null, tl(c, A.props, b, g), Al(c, A.children, g), At(), ur(c), at();
    ...
    ({}).NODE_ENV !== "production" && c.type.__hmrId && pf(c);
    const { bum: b, scope: v, job: I, subTree: B, um: D, m: x, a: y } = c;
    mr(x), mr(y), b && Ft(b), v.stop(), I && (I.flags |= 8, re(B, c, A, g)), D && Le(D, A), Le(() => {
      c.isUnmounted = !0;
    }, A), A && A.pendingBranch && !A.isUnmounted && c.asyncDep && !c.asyncResolved && c.suspenseId === A.pendingId && (A.deps--, A.deps === 0 && A.resolve()), {}.NODE_ENV !== "production" && bf(c);
    ...
    const A = p(c.anchor || c.el), g = A && A[xf];
    return g ? p(g) : A;
  };
  let je = !1;
  const ve = (c, A, g) => {
...
const Il = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${Qe(t)}Modifiers`] || e[`${yt(t)}Modifiers`];
function bl(e, t, ...n) {
  if (e.isUnmounted)
    return;
  ...
  let r = n;
  const s = t.startsWith("update:"), o = s && Il(i, t.slice(7));
  if (o && (o.trim && (r = n.map((a) => fe(a) ? a.trim() : a)), o.number && (r = n.map(Eo))), {}.NODE_ENV !== "production" && wf(e, t, r), {}.NODE_ENV !== "production") {
...
function Ai(e) {
  ...
  let T = L, K;
  if ({}.NODE_ENV !== "production" && L.patchFlag > 0 && L.patchFlag & 2048 && ([T, K] = Fs(L)), G && E !== !1) {
...
function Ws(e) {
  return e.dynamicChildren = ln > 0 ? Re || Xt : null, Dl(), ln > 0 && Re && Re.push(e), e;
}
...
const Te = {}.NODE_ENV !== "production" ? Nl : Us;
function Us(e, t = null, n = null, i = 0, r = null, s = !1) {
  if ((!e || e === Xf) && ({}.NODE_ENV !== "production" && !e && N(`Invalid vnode type when creating vnode: ${e}.`), e = He), ti(e)) {
    const f = Pt(
      e,
      t,
      !0
  ...
  const o = fe(e) ? 1 : Vs(e) ? 128 : Df(e) ? 64 : ie(e) ? 4 : J(e) ? 2 : 0;
...
function Pt(e, t, n = !1, i = !1) {
  const { props: r, ref: s, patchFlag: o, children: f, transition: u } = e, d = t ? Sl(r || {}, t) : r, a = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e.type,
    props: d,
...
function qi(e, t) {
  ...
  if (t == null)
    ...
    J(t) ? (t = { default: t, _ctx: Oe }, n = 32) : (t = String(t), i & 64 ? (n = 16, t = [Ml(t)]) : n = 8);
...
let Ll = 0;
function Ol(e, t, n) {
  const i = e.type, r = (t ? t.appContext : e.appContext) || kl, s = {
    uid: Ll++,
    vnode: e,
    type: i,
    parent: t,
  ...
  return {}.NODE_ENV !== "production" ? s.ctx = Jf(s) : s.ctx = { _: s }, s.root = t ? t.root : s, s.emit = bl.bind(null, s), e.ce && e.ce(s), s;
}
let he = null;
const _i = () => he || Oe;
let Qn, Di;
...
function Tl(e, t) {
  ...
  if (r) {
    At();
    const s = e.setupContext = r.length > 1 ? Xl(e) : null, o = hn(e), f = Zt(
      r,
      e,
      0,
      [
...
function wr(e, t, n) {
  ...
  ), {}.NODE_ENV !== "production" && (e.devtoolsRawSetupState = t), e.setupState = ps(t), {}.NODE_ENV !== "production" && Yf(e)) : {}.NODE_ENV !== "production" && t !== void 0 && N(
...
function $i(e) {
  return e.exposed ? e.exposeProxy || (e.exposeProxy = new Proxy(ps(_o(e.exposed)), {
    get(t, n) {
      if (n in t)
        return t[n];
      if (n in Ht)
...
const Jl = /(?:^|[-_])(\w)/g, Ql = (e) => e.replace(Jl, (t) => t.toUpperCase()).replace(/[-_]/g, "");
function eo(e, t = !0) {
...
const no = Mi ? (e) => Mi.createHTML(e) : (e) => e, Zl = "http://www.w3.org/2000/svg", Gl = "http://www.w3.org/1998/Math/MathML", ot = typeof document < "u" ? document : null, Nr = ot && /* @__PURE__ */ ot.createElement("template"), Fl = {
  insert: (e, t, n) => {
  ...
  createElement: (e, t, n, i) => {
    const r = t === "svg" ? ot.createElementNS(Zl, e) : t === "mathml" ? ot.createElementNS(Gl, e) : n ? ot.createElement(e, { is: n }) : ot.createElement(e);
...
const Br = Symbol("_vod"), Kl = Symbol("_vsh"), Ul = Symbol({}.NODE_ENV !== "production" ? "CSS_VAR_TEXT" : ""), ql = /(^|;)\s*display\s*:/;
function _l(e, t, n) {
  ...
  if (n && !r) {
    ...
    if (t !== n) {
      const o = i[Ul];
      o && (n += ";" + o), i.cssText = n, s = ql.test(n);
    }
  } else
    t && e.removeAttribute("style");
  Br in e && (e[Br] = s ? i.display : "", e[Kl] && (i.display = "none"));
}
const $l = /[^\\];\s*$/, Mr = /\s*!important$/;
function Nn(e, t, n) {
  if (z(n))
    n.forEach((i) => Nn(e, t, i));
  else if (n == null && (n = ""), {}.NODE_ENV !== "production" && $l.test(n) && lt(
...
let di = 0;
const sc = /* @__PURE__ */ Promise.resolve(), oc = () => di || (sc.then(() => di = 0), di = Date.now());
function fc(e, t) {
  const n = (i) => {
    if (!i._vts)
      i._vts = Date.now();
...
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, cc = (e, t, n, i, r, s) => {
  const o = r === "svg";
  t === "class" ? Wl(e, i, o) : t === "style" ? _l(e, n, i) : An(t) ? Mn(t) || ic(e, t, n, i, s) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : uc(e, t, i, o)) ? (Or(e, t, i), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && Lr(e, t, i, o, s, t !== "value")) : /* #11081 force set props for possible async custom element */ e._isVueCE && (/[A-Z]/.test(t) || !fe(i)) ? Or(e, Qe(t), i, s, t) : (t === "true-value" ? e._trueValue = i : t === "false-value" && (e._falseValue = i), Lr(e, t, i, o));
};
function uc(e, t, n, i) {
  if (i)
...
const Ac = /* @__PURE__ */ Ae({ patchProp: cc }, Fl);
let jr;
function ac() {
  return jr || (jr = dl(Ac));
}
...
const mc = typeof window < "u" && typeof document < "u";
typeof WorkerGlobalScope < "u" && globalThis instanceof WorkerGlobalScope;
const Ic = Object.prototype.toString, bc = (e) => Ic.call(e) === "[object Object]", yc = () => {
};
function Pc(e) {
  return e || _i();
}
...
function Nc(e, t, n = {}) {
  ...
  let s;
  const o = Dc(() => i && "ResizeObserver" in i), f = () => {
...
const nr = Sc() === "pc", Tc = Hc(), zc = "https://mxnewsdata.pages.dev/news_en", jc = "https://news.mxfast.com";
async function Xc(e = {}) {
  const t = e.category || "usa", n = await fetch(`${zc}/${Tc}/${t}.json`), i = [];
  try {
    ...
    if (typeof r == "object" && !r.code)
      for (const s in r) {
        ...
        const f = {
          ...
          link: `${jc}/#/detail/${o.category.toLowerCase()}/${s}`
        };
        i.push(f);
      }
  } catch {
...
const Xr = Date.now(), co = Vc(), Jc = Wc(), Qc = `https://api.taboola.com/2.0/json/maxthonbrowser-${co}/recommendations.get`;
async function Yc(e = {}) {
  const t = Zc(e), i = await (await fetch(Qc, {
    method: "post",
    credentials: "include",
...
function Gc(e, t) {
  const n = e.pn || kc("pn"), i = e.length || 9;
...
function Wc() {
  ...
  return e || (e = Mc(), localStorage.setItem("mx-deviceId", e)), e;
}
const uo = {
  // 获取新闻：参数见 README.md
  getNewsList(e = {}) {
...
const tu = ["src", "data-src"], nu = {
  ...
  setup(e) {
    const t = e, { isLoading: n, error: i } = $c({ src: t.src }), r = ze(() => n.value ? t.placeholder : i.value ? t.error : t.src), s = ze(() => ({
      width: t.width,
...
const iu = ["href"], ru = { class: "mx-news-content" }, su = ["innerHTML"], ou = { class: "mx-news-source" }, fu = { class: "mx-news-date" }, Qr = {
  __name: "MxNewsItem",
  props: {
    // 数据
  ...
  setup(e) {
    ...
    return $n(() => {
      ...
      const s = new IntersectionObserver(
        (o) => {
          o.forEach((f) => {
            f.isIntersecting && (uo.setNewsVisible(t.data.visibleUrl), s.disconnect());
          });
        },
        { threshold: 0.5 }
      );
...
const lu = { class: "mx-news-list" }, cu = {
  ...
  setup(e) {
    const t = e, n = document.querySelector(t.container), i = t.scrollbar ? document.querySelector(t.scrollbar) : document, r = t.scrollbar ? document.querySelector(t.scrollbar) : document.documentElement, { width: s } = Bc(n), o = ze(() => t.autoCols && s.value >= 768), f = et(null), u = ze(() => t.needTop && f.value ? f.value[0] : null), d = ze(() => {
      var E, R;
    ...
    function h() {
      var L;
      if (nr || n.style.display === "none" || t.maxLength && t.maxLength <= ((L = f.value) == null ? void 0 : L.length))
        return;
      const { clientHeight: P, scrollTop: E, scrollHeight: R } = r;
      P + E >= R - 100 && p();
    }
    return p(!0), (P, E) => (ce(), be("div", lu, [
      f.value ? f.value.length ? (ce(), be(Ee, { key: 2 }, [
        ...
        Ke("div", {
          ...
          (ce(!0), be(Ee, null, zn(d.value, (R, L) => (ce(), cn(Qr, {
            key: L,
            data: R,
            "is-top": !1
          }, null, 8, ["data"]))), 128))
...
function au(e = {}) {
  const t = dc(Ao, e), n = document.querySelector(e.container);
  return t.mount(n), {
    destroy() {
