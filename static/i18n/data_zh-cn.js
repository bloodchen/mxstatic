...
var DEFAULT_MY_SITE = [
  ...
  { title: '腾讯新闻', url: 'http://go.maxthon.cn/redir/mx5/qa.htm?f=txxw', image: staticServer + '/v1.1/image/logo/Sq/txxw.png', isHot: true },
  // { 'title': '缤客', 'url': 'http://go.maxthon.cn/redir/mx5/qa.htm?f=booking', 'image': staticServer + '/v1.1/image/logo/Sq/Booking.png', isHot: true },
...
var SITE_LIST = [
  {
    categroy: '推荐站点',
    list: [
      { title: '百度', url: 'https://www.baidu.com/index.php?tn=maxthon2&ch=2', match: ['www.baidu.com'], image: staticServer + '/v1.1/image/logo/Re/baidu.png' },
      ...
      { title: '腾讯新闻', url: 'http://go.maxthon.cn/redir/mx5/qa.htm?f=txxw', image: staticServer + '/v1.1/image/logo/Re/txxw.png' },
      // { 'title': '缤客', 'url': 'http://go.maxthon.cn/redir/mx5/qa.htm?f=booking', 'image': staticServer + '/v1.1/image/logo/Sq/Booking.png'},
