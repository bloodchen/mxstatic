...
$(function () {
    ...
    function skinStatistic(m) {
        window.Api.statistic.webSend({
            ...
            'data': {
                'title': '20171212',
                'url': 'https://s.click.taobao.com/AQQdBXw'
            }
        });
    }
    ...
    document.getElementById('skin').addEventListener('click', function (e) {
        maxthon.webSend("newTabUpground", { url: 'https://s.click.taobao.com/AQQdBXw' }, function (msg) { });
    ...
    (function() {
        ...
        $bannerDom.on('click', '#banner-introduction', function (ev) {
            ev.preventDefault();
            maxthon.webSend("newTabUpground", { url: 'https://www.lives.one' + suffix }, function (msg) { });
        });

        $bannerDom.on('click', '#banner-appointment', function (ev) {
            ev.preventDefault();
            maxthon.webSend("newTabUpground", { url: 'https://www.lives.one/reserve' + suffix }, function (msg) { });
        });
