...
$(function() {
    ...
    function webSend(data) {
        window.Api.statistic.webSend({ m: 'bannerclick', n: data.n });
    }
    ...
    function bindeEvent() {
        ...
        $navigation.on('click', '.close-ad', function() {
            $navigation.height(0);
            Api.getSyncValue('noSyncData', function(data) {
                data = data || {};
                data.isLoaded = 'yes';
...
$(function () {
    ...
    $header.on('click', 'ul > li > a', function (e) {
        e.preventDefault();
        Api.useApi('newTabUpground', { 'url': $(this).attr('href') });
    ...
    var configPanel = (function () {
        ...
        function initOption() {
            ...
            background = [
                ...
                { 'pic': 'maxthon.jpg', 'type': 'video', 'brightness': 'dark', 'data_code': 'maxthon', 'play': true }
            ];
...
$(function () {
    ...
    window.replaceErrorIcon = function () {}
