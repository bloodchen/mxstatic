...
define('widget/header/header', function () {
  ...
  function n(a, n) {
    if (((a = parseFloat(a)), (n = parseFloat(n)), isNaN(a) || isNaN(n) || 0 >= n)) return '1%';
  ...
  function t(a) {
    ...
    (a.suffix = '?uid=' + a.id + 'ln=' + t + '&mxver=' + o.max_version + '&mxpn=' + o.pn), (a.progress = n(a.usedSpace, a.totalSpace)), e(a);
  }

  function e(a) {
    var n = '<ul class="header-action fr">\n				' + s(a) + '\n				<li class="fl">\n					<span class="line">|</span>\n				</li>\n				' + i(a) + '\n			</ul>';
    l.find('.header-action').replaceWith(n), 'Mac' === o.platform && l.find('.switch-action').hide();
  }
  ...
  function i(a) {
    return -1 === a.id
      ...
      : '<li class="fl profile">\n			<span class="login-user">' +
          a.nickname +
          '</span>\n			<div class="profile-dropdown">\n				<img src="' +
          a.avatarUrl.replace(/^(https?:\/\/.+\.maxthon)/, 'https://avatar.maxthon') +
          '" alt="头像" onerror="//pc-newtab.maxthonimg.com/static/img/icon/default.png"/>\n				<div class="profile-continer">\n					<div class="profile-detail">\n						<h4>\n							<span class="user">' +
          a.nickname +
          '</span>\n							' +
  ...
  a(
    ...
    function (n) {
      1 === n &&
        a(
          ...
          function (a) {
            1 === a ? $('.gl').addClass('gt').show() : $('.gl').addClass('lt').show(), (r.sidebar = a);
          }
        ),
        (r.favbar = n);
    }
    ...
    o.useApi('common.registerUIStatusChanged', {}, function (a) {
      $('.gl').removeClass('gt').removeClass('lt').hide(), 1 === a.type ? (1 === a.status && (1 === r.sidebar ? $('.gl').addClass('gt').show() : $('.gl').addClass('lt').show()), (r.favbar = a.status)) : (1 === r.favbar && (1 === a.status ? $('.gl').addClass('gt').show() : $('.gl').addClass('lt').show()), (r.sidebar = a.status));
    });
});
...
define('widget/search/search', function () {
  ...
  // 搜索栏
  function e(e) {
    c.css({ 'background-image': 'url(mx://favicon/' + e.url + ')' }), '5cstlvtmining201712v1' === r.pn && r.max_version.cmpVersions('5.2.2.1000') <= 0 && e.url.match(/https?:\/\/www.sogou.com\/sogou/) && (e.url = 'https://www.sogou.com/web?query=%us');
    // baidu
    if (/https:\/\/www.baidu.com/.test(e.url)) {
      e.url = 'https://go.mxfast.com/bd/';
    }
    var n = e.url.split('?'),
      a = n[0];
    if (n[1]) {
    ...
    l.text(e.name), u.attr('action', a), '百度' != e.name || e.url.match(/^https/) || u.attr('action', a.replace('http', 'https'));
  }
  ...
  function a() {
    f.hide(), l.addClass('down'), $(document).off('keydown'), f.find('p').removeClass('hover');
  }
  ...
  function t(e, n) {
    ...
    n.forEach(function (e, n) {
      a += '<p data-engine=' + n + '><img src="mx://favicon/' + e.url + '" /><span>' + e.name + '</span></p>';
      // baidu
      if (/https:\/\/www.baidu.com/.test(e.url)) {
        e.url = 'https://go.mxfast.com/bd/';
      }
      ...
      (a += '</div>'),
      e.empty().append(a);
    d.attr('placeholder', g.lang[s] || g.lang['en-us']), c.attr('title', Language.getLang('SelectDefaultEngine'));
  }
  ...
  function i() {
    ...
    r.useApi(
              ...
              function (e) {
                ...
                if (t.indexOf('yandex') < 0)
                  (a = {
                    ...
                    hotkey: '',
                    editable: !1,
                    url_addressbar: 'http://yandex.ru/yandsearch?clid=45370&text=%s',
                    url_quickaccess: 'http://yandex.ru/yandsearch?clid=45370&text=%s'
                  }),
                    c.push(a);
                else {
      ...
      r.useApi('config.onChange', {}, function (n) {
        n.key && 'browser.general.default_search_engine2' === n.key && e(JSON.parse(n.value));
      });
  }
    ...
    o.on('click', '.search-engine', function (e) {
      ...
      $(document)
        ...
        .on('keydown', function (e) {
          switch (e.keyCode) {
            case 38:
              0 > t && (t = i), n.find('p').removeClass('hover'), n.find('p').eq(t--).addClass('hover');
              break;
            case 40:
              t > i && (t = 0), n.find('p').removeClass('hover'), n.find('p').eq(t++).addClass('hover');
              break;
            case 13:
    ...
    (o.exports = {
      toggle: function () {
        a.hasClass('isvisible')
          ...
          : (a.addClass('isvisible'), localStorage.removeItem('banner-coin-collapse'));
      }
    });
});
/*!static/js/newWin.js*/
  ...
  var e = (function (t) {
    function i(t) {
      (v = t || {}),
        ...
        (('Win' === E.platform && E.max_version.cmpVersions('5.0.3.200') < 0) || ('Mac' === E.platform && E.max_version.cmpVersions('5.0.16') < 0)) &&
          (S.css({
            left: '0px',
            top: '70px',
            width: '590px'
        ...
        x.on('click', function () {
          var e = $(this);
          e.siblings().removeClass('selected'), e.addClass('selected'), b.find('article').hide().eq(e.index()).show();
        }),
        k.on('click', function () {
          var e = $(this);
          e.siblings('li').removeClass('current'), e.addClass('current'), u(SITE_LIST[e.index()]);
        }),
        C.on('click', function () {
          var t = $(this),
            i = t.index();
        ...
        b.on('click', '.main-warp li:not(.folder) > a', function (e) {
          ...
          return (
            ...
            C.each(function (e, t) {
              return $(t).hasClass('hover') ? ((B = ['currentlyOpen', 'mostVisited', 'maxnote', 'lastSession'][e]), !1) : void 0;
            }),
            (F = 'maxnote' === B ? ('1' !== t.attr('et') ? 'record' : 'website') : void 0),
            !1
          );
        }),
        ...
        b.on('mouseover mouseout', '.main-warp .menu-head,.main-warp .jstree-note', function (e) {
          e.stopPropagation(), 'mouseover' == e.type ? $(this).siblings('.jstree-wholerow').show() : 'mouseout' == e.type && $(this).siblings('.jstree-wholerow').hide();
        }),
        T.on('click', '> li', function (e) {
          ...
          if (!t.hasClass('disable')) {
            ...
            setTimeout(function () {
              ...
              var s = d();
              if (!s) {
                var n = o.isHot === !0 ? Math.min(o.topuiindex + 1, 7) : o.uiindex + 1,
              ...
              if (o.group) Controller.onUpdateGridItem(a), e && (document.body.removeChild(e[0]), (e = null));
              else {
                var c = o.getGridFixed(),
                  m = c.left,
                  u = c.top + document.body.scrollTop + document.documentElement.scrollTop;
                e.css({
                  left: m,
                  top: u
                }),
                  setTimeout(function () {
                    s ? Controller.onUpdateGridItem(a) : Controller.onInsertGridItem(a, o), e && (document.body.removeChild(e[0]), (e = null));
                  }, 300);
              }
              r();
              var f = {
        ...
        q.on('click', function () {
          ...
          if (!e.hasClass('disable')) {
            var t = w.val().trim(),
              i = _.val().trim();
            if ((b.find('.error').hide(), 0 === t.length)) return b.find('.error').eq(0).find('>span').html(Language.getLang('EnterUrl')).end().show(), void w.addClass('error');
            if (t.indexOf('..') > 0 && t.indexOf('..')) return b.find('.error').eq(0).find('>span').html(Language.getLang('CheckUrl')).end().show(), void w.focus();
            e.addClass('disable'), 0 === i.length && (i = t);
            var a = {
              title: i,
              url: t.notUrl() ? 'http://' + t : t
            };
            y.each(function (e, t) {
              var i = $(t);
            ...
            var o = Controller.getGridItem(U).grid;
            o.isHot === !0 && ((a.isHot = !0), (a.image = a.image && a.image.replace('/Re/', '/Sq/')));
            var s = {
              o: o.isHot === !0 ? 'top' : 'fav',
              data: {
                addPosition: o.isHot === !0 ? o.topuiindex : o.uiindex,
            ...
            F && 'maxnote' === B && (s.data.maxnoteCategory = F),
              d()
                ? ((s.n = 'edit'), (s.o += 'Edit'), (a.index = U), Controller.onUpdateGridItem(a))
                : ((s.n = 'add'),
                  (s.o += 'Add'),
      ...
      A.on('input', function () {
        ...
        I.on('click', function (e) {
          var t = $(this);
          e.stopPropagation(), t.parent().hasClass('disable') || ((V = t.attr('class')), t.siblings().removeClass('selected').end().addClass('selected'));
        }),
        y.on('click', function () {
          var e = $(this),
            t = {
    ...
    function o() {
      ...
      for (
        ...
        for (var a = SITE_LIST[i].list, o = 0; o < a.length; o++) {
          var s = a[o];
          (-1 === s.url.indexOf(e) && -1 === s.title.indexOf(e)) || t.list.push(s);
        }
          ...
          after: function () {
            b.find('.close')
              ...
              .on('click', function () {
                ...
                x.each(function (e, t) {
                  return $(t).hasClass('selected') ? ((B = ['default', 'custome'][e]), !1) : void 0;
                });
                var i = {
                  n: t ? 'edit' : 'add',
    ...
    function r() {
      var e = N;
      return l(), q.removeClass('disable'), w.removeAttr('disabled').removeAttr('style').removeClass('error'), y.removeClass('disabled').removeClass('selected').eq(1).addClass('selected'), I.removeClass('selected').eq(0).addClass('selected'), e === !0 ? (b.hide(), $group_dialog.show(), !1) : void M.close();
    }

    function n(e) {
      (e = e || {}), (U = e.index), (O = e.uiindex), (D = e.title || ''), (P = e.url || ''), (W = e.image || ''), (V = e.colorBlock || 'color-block-6'), (z = e.thumbType), c(), (z = d() ? ('' === W ? 2 : W.startWith('mx://thumbs/?reflush') ? 1 : 0) : 1);
      var t = {};
      switch (z) {
        case 2:
          t.colorblock = {
    ...
    function l() {
      (U = ''), (P = ''), (D = ''), (W = ''), (V = ''), (B = void 0), (z = void 0), (F = void 0), (N = void 0);
    }
    ...
    function m(e, t) {
      ...
      for (var o in i)
        if (i[o]) {
          var s = i[o].index;
          i[o].disable === !0 ? (y.eq(s).addClass('disabled'), y.eq(s).hasClass('selected') && (t = !0), y.eq(s).addClass('disabled')) : (y.eq(s).removeClass('disabled'), y.eq(s).removeClass('disabled')), t && i[o].checked === !0 && a(y.eq(s));
        }
    }
    ...
    function u(e) {
      for (var t = [], i = 0; i < e.list.length; i++) {
        var a = e.list[i],
          o = [];
        v[a.url] && ((a.sq_img = v[a.url].sq_img || ''), a.sq_img && '' !== a.sq_img && o.push('d-sq-img="' + a.sq_img + '" '), (a.re_img = v[a.url].re_img || ''), a.re_img && '' !== a.re_img && o.push('d-re-img="' + a.re_img + '" '), (a.re_md5sum = v[a.url].re_md5sum || ''), a.re_md5sum && '' !== a.re_md5sum && o.push('d-re-md5="' + a.re_md5sum + '" '), (a.sq_md5sum = v[a.url].sq_md5sum || ''), a.sq_md5sum && '' !== a.sq_md5sum && o.push('d-sq-md5="' + a.sq_md5sum + '" ')), (a = grid.tranData(a)), t.push('<li>'), t.push('<a href="' + a.url + '" d-title="' + a.title + '" d-image="' + a.image + '" ' + o.join('') + ' target="_blank">'), t.push('<img class="grid-img" src="' + a.image + '" width="150" height="100"/>'), t.push('<p class="grid-title">' + a.title + '</p>'), t.push('</a>'), t.push('</li>');
      }
    ...
    function f(e, t) {
      for (var i = ['<ul>'], a = 0; a < e.length; a++) {
        var o = e[a];
        i.push('<li>                        <a href="' + o.url + '" title="' + o.title + '">                            <img src="mx://favicon/' + o.url + '" alt="' + o.title + '" height="16" width="16" onerror="this.src=\'' + staticServer + '/img/icon/6000.png\'" class="nav-icon" />                            <span class="nav-text">' + o.title + '</span>                        </a>                        </li>');
      }
        ...
        function (i) {
          ...
          if (o) {
            for (var s = 0; s < o.length; s++) {
              var r = o[s] || {};
              a += '<li>                            <div class="jstree-wholerow"></div>                            <a class="jstree-note" href="' + (1 !== r.et ? 'mx://note/?id=' + r.uuid + '&pid=' + e : r.url) + '" title="' + r.fn + '" et="' + r.et + '">                                <img src="' + (1 !== r.et ? staticServer + '/img/icon/note.svg' : 'mx://favicon/' + r.url) + '" alt="' + r.fn + '" height="16" width="16" onerror="this.src=\'' + staticServer + '/img/icon/6000.png\'" class="nav-icon" />                                <span class="nav-text">' + r.fn + '</span>                            </a>                        </li>';
            }
            t && t(a);
          }
        }
    ...
    function g(e) {
      if (0 != e.length) {
        var t = e.notUrl() ? 'http://' + e : e,
          i = /^((https|http)?:\/\/)+[A-Za-z0-9]+\.[A-Za-z0-9]+[\/=\?%\-&_~`@[\]\':+!]*([^<>\"\"])*$/;
        if (!i.test(t)) return '';
        ...
        var o = /.*\:\/\/([^\/]*).*/,
          ...
          r = '',
          n = '';
        if (('undefined' != typeof s && null != s && (r = 'https://vk.com/maxthon_ru' === s[0] || 'https://facebook.com/maxthon.org.ru' === s[0] || 'http://maxthon.org.ru' === s[0] ? s[0] : s[1]), 'go.maxthon.com' === r || 'go.maxthon.cn' === r)) return '';
    ...
    function p(e, i) {
      return 0 == i ? 'mx://thumbs/?reflush=' + i + '&stamp=' + new Date().getTime() + '&url=' + e : 1 == t.onLine ? 'mx://thumbs/?reflush=' + i + '&stamp=' + new Date().getTime() + '&url=' + e : cdnServer + '/image/logo/Re/offline.png';
    }
    var v,
      b,
      x,
    ...
    'Win' === E.platform && E.max_version.cmpVersions('5.1.4.800') >= 0 && ((H = 'note.getFoldersTree'), (G = 'note.getEntriesByPid'));
  ...
  var e = (function () {
    ...
    function t() {
      ($config_layer = $('#config-layer')),
        ...
        f.cmpVersions('5.0.4.400') < 0 && (k.splice(2, 5), k.splice(k.length - 1, 1)),
        f.cmpVersions('5.0.3.400') < 0 && $config_layer.find('.tips').remove() && $config_layer.find('.a-upload').height(0);
      var e = [];
      k.forEach(function (t) {
        e.push('<li class="skin-img-item" name="' + t.data_code + '">'), e.push(' <a href="javascript:void(0);">'), e.push('     <img class="skin-img-item-img" src="' + d(t.pic, !0) + '" />'), 'video' === t.type && e.push('     <div class="operate-button loading"></div>     '), e.push(' </a>'), e.push('</li>');
      }),
        ...
        c(function (e) {
          ...
          if ((t && t.length && ((y.bgIndex = -1), (y.customBackground = t)), -1 === y.bgIndex && y.customBackground)) {
            var s = new Image();
            (s.onload = function () {
              n(y.customBackground), o(), r();
            }),
              (s.onerror = function () {
                (y.bgIndex = 4), a(y.bgIndex, k[y.bgIndex].pic), o(k[y.bgIndex].brightness), r();
              }),
              (s.src = y.customBackground);
          } else {
            var c = k[y.bgIndex];
            c || (c = k[0]), 'picture' === c.type ? n(d(c.pic, !1)) : a(y.bgIndex, c.pic), u.find('>li').removeClass('selected').eq(y.bgIndex).addClass('selected'), o(c.brightness);
          }
          skinDisplay && skinDisplay === !0 && (localStorage.setItem('BODY_CLASS_NAME', document.body.className), (document.body.className = ''), (document.getElementById('skin').style.display = 'block'), (document.getElementById('siderbar').style.display = 'none')), i();
        });
    }
    ...
    function i() {
      function e(e) {
        ...
        i ? v.paused || (s(!1), (t = !0)) : t === !0 && v.paused && (s(!0), (t = !1));
      }
      $config_layer.find('.upload').on('click', function () {
        b.useApi('quickaccess.selectBgImage', {}, function (e) {
          if (e && e.succeed === !0) {
            var t = 'mx://newtab/user_custom_bg_image.png?v=' + new Date().getTime();
            (y.bgIndex = -1), (y.customBackground = t), r(), n(t), o(), u.find('>li').removeClass('selected');
          }
        });
      }),
        p.on('click', function () {
        ...
        $config_layer.on('click', '.close', function () {
          $config_layer.removeAttr('style'), $('#mx_mask_layer').hide().unbind('click'), (window.onresize = null);
        }),
        u.on('click', 'li', function (e) {
          var t = $(this);
          if (!t.hasClass('selected') && !$(e.target).hasClass('operate-button')) {
    ...
    function a(e, t) {
      ...
      var i = k[e].play;
      e === y.bgIndex && (i = y.play === !1 ? !1 : !0), i === !0 ? s(!0) : (s(!1), $config_layer.find('.operate-button').removeClass('loading').addClass('start')), h.removeAttr('style'), (v.style.display = 'block');
    }
    ...
    function d(e, t) {
      return staticServer + '/img/bg/' + (t ? 'preview/' : '') + e + (window.Api.Tools.isSupportWebp() ? '.webp' : '');
    }
    ...
    function g(e) {
      console.time('calc color'),
        RGBaster.colors(e, {
          success: function (e) {
            console.timeEnd('calc color'), (brightness = e.dominant < 128 ? 'light' : 'dark'), $('body').attr('class', brightness);
          }
        });
    }
    var p,
...
(grid.tranData = function (e) {
  if (e.image || e.colorBlock) {
    if (e.image && (delete e.colorBlock, (e.image = e.image.replace(/^http:\/\//, 'https://')), !e.image.match(/^mx:\/\/thumbs\/\?/) && !e.image.match(/^https?:\/\/fastdail-img/))) {
      var i;
      ...
      window.Api.Tools.isSupportWebp() && (i += '.webp'),
        /* (e.sq_md5sum || e.re_md5sum) && (i += "?md5="  + (e.isHot === !0 ? e.sq_md5sum : e.re_md5sum) ), */
        (e.image = cdnServer + '/image/logo/' + (e.isHot === !0 ? 'Sq/' : 'Re/') + i);
    }
  ...
  $(function () {
    ...
    t.prototype = (function () {
      ...
      function s(e, i) {
        var t = '';
        (e = grid.tranData(e)), e.image ? (e.image.startWith('mx://thumbs') ? (t += '<div class="thumbnail loading" url="' + e.url + '"></div>') : ((t += '<div class="thumbnail" '), (t += '   style="background-image: url(' + e.image + ')">'), (t += '</div>'))) : ((t += '<div class="thumbnail ' + e.colorBlock + '">'), (t += '   <span>' + e.title + '</span>'), (t += '</div>'));
        var n = $(t)[0];
      ...
      function p(e, i) {
        if (e || this.children) {
          var t,
            ...
            i = i || n.children,
            o = i.length;
          for (e.innerHTML = '', n.thumburls = [], t = 0; (o > 4 ? 4 : o) > t; t++) n.addGridThumbnailNode(i[t], e), n.thumburls.push(i[t].url);
              ...
              window.Api.Tools.isThumbExists(n.thumburls, function (e) {
                ...
                e.forEach(function (e, t) {
                  ...
                  if (e === !0 && -1 !== o.className.indexOf('loading')) {
                    var r = n.thumburls[t];
                    (o.className = 'thumbnail'), (o.style.cssText = 'background-image : url(' + newWin.getThumbsUrl(r, 0) + ')');
                  }
                });
              });
            }, 10);
      ...
      function v(e) {
        var i,
          ...
          l,
          s = g;
        if (this.isHot === !0) (i = 8), (e = e || this.topuiindex), (r = J.floor(e / i)), (d = e % i), (t = 0.125 * s.top_container_width), (a = t * d), (l = 0);
        else if (((e = e || this.uiindex), !this.children && this.group)) (t = 153), (n = 11.256), (o = 330 * 0.02), (i = 5), (r = J.floor(e / i)), (d = e % i), (a = (t + 2 * n) * d), (l = (0.7 * t + o) * r);
        else {
          var u = s.container_width;
          u > 0 && ((i = 6), (t = 0.15 * u), (n = 0.008 * u), (o = 0.01 * u), (r = J.floor(e / i)), (d = e % i), (grid_top = (0.7 * t + o) * r), (a = (t + 2 * n) * d), (l = grid_top));
        }
        return {
          left: a,
          top: l
      ...
      function G(e) {
        if (!e.group || '' === e.group) {
          ...
          (t.n = e.isHot === !0 ? 'top' : 'myfav'), datacode && datacode.statistic(t), _(e);
        }
        return (
          e.isHot === !0 &&
          ...
          e.url && e.url.startWith('mx://note/?id')
            ? (u.useApi(
                ...
                function (e) {
                  0 !== e && (a && a.close(), window.Api.Tools.showNoteNotFound(e));
                }
              ),
              !1)
            : (e.url.match(/^file:\/\/.*/) || e.url.match(/^mx:\/\/.*/)
                ? setTimeout(function () {
                    u.useApi('newTabUpground', {
                      url: e.url
                    });
                  }, 0)
          ...
          (a = $group_dialog.dialog({
            init: function () {
              ...
              r.children.forEach(function (t) {
                return t.node.hasClass('loading') ? (e.push(t.url), void i.push(t)) : !0;
              }),
      ...
      function C(e) {
        var i = e;
        return i.children ? void window.Api.Tools.showDeleteFolder(i) : (f.onRemoveGrid(i.index), void datacode.removeGrid(e));
      }
      ...
      function k(e) {
        var i,
          t = e,
          n = r;
        e.group && '' !== e.group && a && (a.close(), $group_dialog.attr('edit', !0), (i = !0), (r = n)),
          newWin.showDialog(
            {
              index: t.index,
      ...
      function A(e, i) {
        var t,
          o,
          r = n();
        if (((i.top += r.top), (i.bottom += r.top), (i.left += r.left), (i.right += r.left), e.left > i.right || i.left > e.right || e.top > i.bottom || i.top > e.bottom)) return 0;
        (t = e.left > i.left ? i.right - e.left : e.right - i.left), (o = e.top > i.top ? i.bottom - e.top : e.bottom - i.top);
      ...
      function y(e) {
        ...
        return e.left - o.right > i || e.right - o.left < i || e.top - o.bottom > t || e.bottom - o.top < i ? !0 : !1;
      }

      function H(e) {
        (m.top = document.body.scrollTop + document.documentElement.scrollTop), (m.bottom = m.top + document.documentElement.clientHeight);
        var i = m.top + 10 - e.top,
          t = e.bottom - m.bottom + 10;
        if (i > 0) Y ? K.addHeight(i / 2) : (K.up(e), (Y = !0));
        else if (t > 0 && e.top < m.height) Y ? K.addHeight(t / 2) : (K.down(e), (Y = !0));
        else {
          if (!Y) return;
          K.stop(), (Y = !1);
        }
      ...
      function j(e) {
        var i,
          t,
          n = 0;
        for (t = r ? r.children : c, i = t.length; i > n && ('Add' === t[n].title || 'Empty' === t[n].title || e(t[n], n) !== !1); n++);
      }

      function D(e, i) {
        return (e.isHot === !0 && i.isHot !== !0) || (e.isHot !== !0 && i.isHot === !0);
      }
      ...
      function S(e) {
        if ((H(e), !R)) {
          ...
          if (O.children)
            (i = O.children),
              j(function (i, n) {
                return n !== O.uiindex && !D(O, i) && ((t = A(e, i.getGridFixed())), t > Q) ? (E(), f.onMovingGrid(O.index, i.index, ''), !1) : void 0;
              });
          else if (U) (t = A(e, U.getGridFixed())), D(O, U) ? (t > Q ? o.addClass('swap') : (o.removeClass('swap'), U.removeClass('combo'), U.removeClass('current'), (U = null))) : (t > Q && (E(), f.onMovingGrid(O.index, U.index, O.group)), (z > t || t > Q) && (U.removeClass('combo'), (U = null)));
          else if (r) {
            if (y(e)) return E(), l && (n = l), void f.onMovingGrid(O.index, n.index, O.group);
            j(function (i, t) {
              return t !== O.uiindex && A(e, i.getGridFixed()) > Q ? (E(), f.onMovingGroup(O.index, i.index, O.group), !1) : void 0;
            });
          } else
            j(function (i, n) {
              if (n !== O.uiindex && ((t = A(e, i.getGridFixed())), t > z)) {
                if (((U = i), D(O, U))) U.addClass('current');
                  ...
                  if (t > Q) return E(), f.onMovingGrid(O.index, i.index, O.group), !1;
                  U.addClass('combo');
                }
                return !1;
              }
      ...
      function M() {
        return grid.render(this.isHot === !0 ? grid.hot_grid_html : grid.grid_html, this);
      }
      ...
      function W() {
        function i(e) {
          if (0 === e.button && !N.node.hasClass('loading') && !o) {
            ...
            (g = i.left), (m = i.top), (v = e.clientX), (b = e.clientY), document.addEventListener('mousemove', t, !1), document.addEventListener('mouseup', a, !1);
          }
        }
        ...
        function a() {
          if ((Y && ((Y = !1), K.stop()), document.removeEventListener('mousemove', t, !1), document.removeEventListener('mouseup', a, !1), w))
            if (((w = !1), T && clearTimeout(T), !U || r)) d();
            else {
              if ((U.removeClass('combo'), X && clearTimeout(X), D(O, U))) {
                if (O.children || U.children) return d(), U.removeClass('current'), void (U = null);
                f.onSwappingGrid(O.index, I(O, U));
              } else if (O.isHot === !0 && U.isHot === !0) d();
              else if (U.children) {
                var e = U.children;
                f.onMovingInGroup(O.index, e[e.length - (O.uiindex > U.uiindex ? 1 : 1)].index, U.title);
              } else f.onAddGroup(O.index, U.index, Language.getLang('NewFolder'));
              U = null;
            }
        }
        var s,
          ...
          N.url || N.children
            ? (N.children
                ? ((N.group = N.title),
                  ...
                  (c = $(['<div class="function">', '<strong class="title">', N.group, '</strong>', '<button class="delete">×</button>', '</div>'].join(''))),
                ...
                : ((s = $(N.html())),
                  s.on('click', function (e) {
                    ...
                    return u.max_version.cmpVersions('5.0.1.1600') > 0 ? (G(N), !1) : !0;
                  }),
                  N.image &&
                    ...
                    window.Api.Tools.isThumbExists([N.url], function (e) {
                      e.forEach(function (e) {
                        e === !0 ? N.node.removeClass('loading') : window.Api.Tools.reflushThumb(N.url);
                      });
                    }))),
              s.on('mousedown', function (e) {
                e.stopPropagation(), e.preventDefault(), i(e), 1 === e.button && _(N);
              }),
              s.on('contextmenu', function (e) {
                x(N, e.clientX, e.clientY), e.stopPropagation(), e.preventDefault();
              }))
            : (N.isHot === !0 ? (s = $('Add' === N.title ? grid.add_grid : grid.empty_grid_html)) : ((s = $(grid.add_grid.replace('top', 'main add'))), (l = N)),
              s.on('click', '.add', function () {
                newWin.showDialog(
                  {
                    index: N.index,
                    uiindex: N.topuiindex || N.uiindex
                  },
                  !1
                );
              })),
          ...
          function i() {
            (R = !0),
              (c = setInterval(function () {
                (l = p.scrollTop()), (l += u), p.scrollTop(l), ((u > 0 && l + a >= s) || (0 > u && 0 >= l)) && o();
              }, m));
          }
    ...
    var f = (function () {
        function a() {
          (S = $('.nav-body')),
              ...
              e.stopPropagation(),
                d.hasClass('editable') ||
                  ...
                  (document.onkeydown = function (e) {
                    return 13 === e.keyCode ? (d.removeClass('editable'), !1) : !0;
                  }));
            }),
            d.on('blur', function () {
              var e = this.value.trim(),
                i = e.replace(/[^\x00-\xff]/g, '**').length;
              0 === i && (e = Language.getLang('NewFolder')), i > 20 && (e = e.substring(0, 20));
            ...
            (g.height = 0.15 * g.container_width * 0.7 + 0.01 * g.container_width);
        }

        function f() {
          (g.top_container_width = $top_container.width()), (g.container_width = S.width()), T();
        }
          ...
          (c = []),
            ...
            e.forEach(function (e) {
              if (e) {
                ...
                if (e.url) {
                  e.url = e.url.replace('go.maxask.com', 'go.mxfast.com');
                  if (/https:\/\/www.baidu.com/.test(e.url)) {
                    e.url = 'https://go.mxfast.com/bd1/';
                  }
                }
                  ...
                  e.isHot === !0
                    ...
                    : (e.children &&
                        e.children.forEach(function (i, t) {
                          if (i.url) {
                            i.url = i.url.replace('go.maxask.com', 'go.mxfast.com');
                            if (/https:\/\/www.baidu.com/.test(i.url)) {
                              i.url = 'https://go.mxfast.com/bd1/';
                            }
                          }
        ...
        function w(e) {
          p[e.url] && ((e.sq_img = p[e.url].sq_img || 'offline.png'), (e.re_img = p[e.url].re_img || 'offline.png'), (e.re_md5sum = p[e.url].re_md5sum || ''), (e.sq_md5sum = p[e.url].sq_md5sum || ''));
        }
              ...
              e.children
                ? ((i = new t(e, n)),
                  ...
                  e.children.forEach(function (e, n) {
                    (e.group = i.title), (e = new t(e, n)), w(e), i.container.append(e.dom()), (i.children[n] = e);
                  }),
                  $group_list.append(i.container),
                  $grid_container.append(i.dom()),
                  (e = i))
                : ((e = new t(e, n)), w(e), e.isHot === !0 ? $top_container.append(e.dom()) : $grid_container.append(e.dom())),
                (e.index = n),
                (c[n] = e);
            });
        }
        ...
        function _(e, i, t) {
          ...
          i > 1 && (o += 50),
            ...
            setTimeout(function () {
              e.addClass('small'),
                setTimeout(function () {
                  e[0].style.cssText = 'left:' + r + 'px; top: ' + o + 'px; width:71px; height: 46px;';
                }, 5);
            }, 5);
        }
        ...
        function T() {
          ...
          c.forEach(function (n, o) {
            ...
            ($grid_container[0].style.height = c[c.length - 9].getGridPosition().top + n + 'px'),
        ...
        function A(i, t, n) {
          ...
          if ((s.j >= 0 && (d = c[s.i]), u.j >= 0 && (a = c[u.i]), p.setGroupName(n), a.children.splice(a.children.length, 0, c.splice(s.i, 1)[0]), $grid_container[0].removeChild(p.node[0]), a.container.append(p.node), o && !r)) {
            p.removeClass('draging'), p.removeClass('notran'), (l = a.children.length - 1);
            var g = a.getGridFixed();
            _(o, l, g),
              setTimeout(function () {
                a.addLastGridThumbnailNode(), window.Api.Grid.insertGridItem(s.i, u.i), T(), e();
              }, h);
          }
          datacode.moveGrid(!1, !1);
        }
        ...
        function y(i, n, r) {
          ...
          (d = f.children),
            i > n ? ((d[1] = c.splice(s.i, 1)[0]), (d[0] = c.splice(p.i, 1)[0])) : ((d[0] = c.splice(p.i, 1)[0]), (d[1] = c.splice(s.i, 1)[0])),
            o &&
              ((l = g.getGridFixed()),
              (a = g.cloneGridNode()),
              a.css({
          ...
          v.css({
            ...
            o &&
              ...
              _(o, 1, l),
              setTimeout(function () {
                v.removeAttr('style'), window.Api.Grid.addGridGroup(m, s.i, p.i, r), T(), e(), a.remove();
              }, h - 150)),
        ...
        function H(i, r) {
          ...
          o &&
            ...
            (p = $.extend({}, v)),
            (dragData = $.extend({}, m)),
            m.isHot === !0 ? ((p.isHot = !0), (p.topuiindex = m.topuiindex), (dragData.isHot = !1), delete dragData.topuiindex, (dragData.uiindex = v.uiindex)) : ((dragData.isHot = !0), (dragData.topuiindex = v.topuiindex), (p.isHot = !1), delete p.topuiindex, (p.uiindex = m.uiindex)),
            (s = new t(p, m.uiindex)),
            ...
            o &&
              setTimeout(function () {
                u.node.removeClass('draging'), s.node.removeClass('draging'), window.Api.Grid.swapGridItem(g.i, E(p), f.i, E(dragData)), T(), e(), d.remove(), datacode.moveGrid(!0, !1);
              }, h);
        }
        ...
        function I(e, i) {
          var n,
            ...
            r,
            d = i || l;
          (o = c), (n = d.uiindex), d.isHot === !0 && (e.topuiindex = d.topuiindex), (e.uiindex = n), (r = new t(e, n)), o.splice(n, 0, r), d.node.parent().append(r.dom()), window.Api.Grid.insertGridItem(n, -1, E(e)), T();
        }
        ...
        function j(e) {
          var i,
            ...
            r = o.i,
            d = o.j;
          0 > d ? (e.isHot === !0 && (e.topuiindex = o.grid.topuiindex), (n = new t(e, r)), (i = c[r].node.parent()), (c[r] = n), (n.uiindex = r)) : ((e.group = o.grid.group), (n = new t(e, d)), (c[r].children[d] = n), (n.uiindex = d), (i = c[r].container), c[r].addLastGridThumbnailNode()), i.append(n.dom()), o.grid.node.remove(), T(), window.Api.Grid.updateGridItem(r, d, E(e));
        }
      ...
      if (!$.isEmptyObject(e))
        switch ((console.log(e), e.type)) {
              ...
              function (e) {
                for (var i = 0; i < c.length; i++) {
                  ...
                  if (t.children && t.children.length > 0)
                    for (var n = t.children, o = t.list_node.childNodes, r = Math.min(n.length, 4), d = 0; r > d; d++) {
                      var a = o[d];
                      if (((t = n[d]), -1 !== a.className.indexOf('loading') && e === t.url)) {
                        (a.className = 'thumbnail'), (a.style.cssText = 'background-image : url(' + newWin.getThumbsUrl(t.url, 0) + ')');
                        break;
                      }
                    }
                }
          ...
          case 'dataSyncCompleted':
            if (u.max_version.cmpVersions('5.0.3.400') > 0) return void s.Grid.getGridDataList();
          ...
          case 'addNewSite':
            ...
            t.image || (t.image = 'mx://thumbs/?reflush=0&stamp=' + new Date().getTime() + '&url=' + t.url),
...
$(function () {
  ...
  $('body').append(
    `<div class="update-toast" style="position: fixed;top: 0;right: 0;bottom: 0;left: 0;z-index: 99;display: flex;align-items: center;justify-content: center;">
        <div class="update-toast-content" style="padding: 60px;background-color: #212121;box-shadow: 0px 3px 6px rgba(0,0,0,0.16);border-radius: 4px;font-size: 14px;font-weight: bold;line-height: 20px;color: #FEFEFE;user-select: none;">
          <span>此版本已经过期，请</span><a style="color: #FEFEFE;text-decoration: underline;" href="https://www.maxthon.com/download-ie.html?env=formal" target="_blank">更新</a>
        </div>
      </div>`
  );
  ...
  function t(t) {
    var e = Api.Maxthon.max_version,
      n = Api.Maxthon.pn,
      i = 'zh-cn' === t ? t : 'en-us';
    return 'ru-ru' === t && (i = 'ru-base'), '7201577005' === n && 'ru-ru' === t && (i = t), 'ruixing' !== n || 'zh-cn' !== t || ('5.1.1.1000' !== e && '5.1.2.3000' !== e) || (i = 'ruixing'), ('5cstbaidu201811v1' === n || '5cstbaidu201811v2' === n) && (i = 'baidu_201811'), a('page_data', 'local_page_data', t, '/static/res/i18n/data_zh-cn.js');
  }
  ...
  function a(t, e, a, n) {
    return new Promise(function (i) {
      ...
      r && (r = JSON.parse(r)) && r.lang === a && r.version === o && !$.isEmptyObject(r.data)
        ? i(r.data)
  ...
  function n(t) {
    var e,
      a = __PRELOAD__['map_list.json'] || JSON.parse(localStorage.getItem('MAP_LIST_JSON')),
      n = window.Api.Maxthon;
    if ('zh-cn' === l && a && a.activity && a.activity.length > 0) {
      var c = Date.now();
      a.activity.forEach(function (t) {
        (t.stime = t.stime), (t.etime = t.etime), t.stime < c && c < t.etime && (e = t);
      });
    }
    var s = template(t, {
      lang: l,
    ...
    (document.getElementById('wrapper').innerHTML = s), window.Api.Grid.getGridDataList(a), e && i(e), 'zh-cn' == l && r('2021-10-20-0', '2021-11-12-0') && o();
    var v = !0,
      d = null;
    if (
      ($('.nav-header-menu li').on('mouseover mouseout', function (t) {
        ...
        d && clearTimeout(d),
          (d = setTimeout(
            function (t) {
              'mouseover' == t &&
                ('feed' !== i && u ? $('#activity-floater').show() : $('#activity-floater').hide(),
  ...
  function c(t) {
    var e = new Date(),
      a = t.split('-'),
      n = 1e6 * e.getFullYear() + 1e4 * (e.getMonth() + 1) + 100 * e.getDate() + e.getHours(),
  ...
  function s() {
    var t = window.Api.statistic.webSend,
      e = '2023-10-24-20',
      a = '2023-11-11-24',
      n = 'https://s.click.taobao.com/TyaTW7u';
    !c(e) && c(a)
  ...
  Promise.all([e(l), t(l)])
    ...
    $(document)
      ...
      .on('dragstart', function (t) {
        return $(t.target).closest('.allow-drag').length ? void 0 : (t.preventDefault(), !1);
      }),
...
$(function () {
  ...
  function i(n) {
    (n = n || {}), n.lastmodify != localStorage.getItem('has-update-plugin-' + g) && ((f = n.lastmodify), $('.switch-action').addClass('has-update')), l(n.data.slice(0, 2)), e(n.data.slice(2, 6)), o();
  }
  ...
  function a(n) {
    return '<div class="plugin-list-item" file_def="' + n.file_def + '" file_url="' + n.download_url + '" file_id="' + n.file_id + '"><a href="' + n.url + '" target="_blank"><img src="' + n.icon_img + '" alt=""><div class="plugin-list-title">' + n.title + '</div><a href="' + n.download_url + '" class="plugin-list-btn">' + Language.getLang('hotPluginAdd') + '</a></a></div>';
  }

  function u() {
    return '<a href="' + p + '/all/hot.php" target="_blank" class="plugin-list-add"><i></i><div class="plugin-list-title">' + Language.getLang('hotPluginMore') + '</div></div>';
  }

  function o() {
    $('.plugin-list-btn, .plugin-new-add').on('click', function (n) {
      window.external && external.mxCall && (n.preventDefault(), s($(this).parent(), 'app'));
    });
  }
  ...
  function r(n, i, l, t) {
    var e = d(n, i);
    -1 !== e ? ((l = l.replace(/^https/, 'http')), 'skin' === t ? external.mxCall('InstallSkin', l) : 'app' === t && external.mxCall('InstallApp', l)) : window.open(l);
  }
  ...
  function c(n) {
    for (var i = n.split('.'), l = 0; l < i.length; l++) i[l] = parseInt(i[l], 10);
    return i;
  }
  var f,
...
!(function () {
  function e() {
    var e = '',
      t = '';
    $.each(h, function (i, n) {
      (e += '<a href="#"data-category="' + n.category + '">' + n.title + '</a>'), (t += '<div class="feed-pane"></div>');
    }),
  ...
  function a(e, t) {
    return '<a class="word-item" href="' + t.url + '" target="_blank"><div class="word-item-left">' + e + '.<span class="word-item-title">' + t.key + '</span></div><div class="word-item-right">' + (t.tendency > 0 ? '<i></i>' : '') + t.count + '</div></a>';
  }
  ...
  function c() {
    $('.feed-header').on('click', 'a', function (e) {
      ...
      var t = $(this),
        i = t.index();
      t.hasClass('active') || (t.siblings('.active').removeClass('active'), t.addClass('active'), (w = i), d(i));
    }),
      $(window).on('scroll', function () {
        $('#infobox').is(':visible') && ($(document).height() - ($(window).height() + window.scrollY) < 100 && r(w), m());
      }),
  ...
  function s(e) {
    e ? ($('.feed-pane').hide(), $('.news-loading').show()) : ($('.feed-pane').eq(w).show(), $('.news-loading').hide()), $('.news-load-error').hide();
  }
  ...
  function getDateTime(time) {
    ...
    return yy + '-' + pre0(MM) + '-' + pre0(dd) + ' ' + pre0(hh) + ':' + pre0(mm);
  }
  ...
  function d(e) {
    var t;
    ('number' == typeof e && e in h) || (e = 0), (t = h[e].category), s(!0);
    $.ajax({
      url: h[e].api,
      dataType: e === 0 ? 'jsonp' : 'json',
      cache: !1,
      timeout: 6e3,
      success: function (i) {
        var n;
        const list = Array.isArray(i) ? i : i.items || i.news.text || i.news.imgText;
        u[t] = list.map(item => {
          const time = item.time || item.pubtime;
          const img = item.img || item.imgurl;
          return {
            time: time ? getDateTime(time * 1000) : '',
            title: item.title,
            link: item.url || item.link,
            images: item.images || [img]
          };
        });
        $('.feed-pane').eq(e).empty();
        n = r(e);
        s(!1);
      },
      error: function () {
        $('.feed-pane').hide(), $('.news-loading').hide(), $('.news-load-error').show();
      }
    });
  }
  ...
  function l(e) {
    ...
    return (
      $.each(e.images, function (i, n) {
        t += '<div class="feed-item-img"><img src="' + n + '" alt="' + e.title + '"></div>';
      }),
      (t += '<div class="feed-item-img-more"><span>查看更多&nbsp;&gt;</span></div>'),
      '<a class="feed-item" target="_blank" href="' + e.link + '"><h4 class="feed-item-header">' + e.title + '</h4><div class="feed-item-img-list clearfix">' + t + '</div><div class="feed-item-info"><span class="feed-item-time">' + (e.ctime || e.time) + '</span></div></a>'
    );
  }

  function f(e) {
    return '<a class="feed-item single clearfix" href="' + e.link + '" target="_blank"><div class="feed-item-img-list clearfix"><div class="feed-item-img"><img src="' + e.images[0] + '" alt="' + e.title + '"></div></div><h4 class="feed-item-header">' + e.title + '</h4><div class="feed-item-info"><span class="feed-item-time">' + (e.ctime || e.time) + '</span></div></a>';
  }

  function m() {
    document.documentElement.scrollTop > 300 ? $('#back_top').fadeIn() : $('#back_top').fadeOut();
  }
  var h = [
      {
        category: 'hot',
        title: '推荐',
        api: 'https://data1.cnr.cn/channelapi/channel/news?channel=a0ff02c694cd0b623b2d0fd7f17cecdc'
      },
      {
        category: 'guoj',
        title: '国际',
        api: 'https://api.fanppp.cn/Apiaoyou2/xxl/guoj'
      },
      {
        category: 'sheh',
        title: '社会',
        api: 'https://kan.content.pcshaobin.cn/api_content_json/shehui.json'
      },
      {
        category: 'juns',
        title: '军事',
        api: 'https://ayhz.miercn.com/ay_bq/list.json'
      },
      {
        category: 'yule',
        title: '娱乐',
        api: 'https://kan.content.pcshaobin.cn/api_content_json/yule.json'
      },
      {
        category: 'tiyu',
        title: '体育',
        api: 'https://kan.content.pcshaobin.cn/api_content_json/tiyu.json'
      },
      {
        category: 'qich',
        title: '汽车',
        api: 'https://kan.content.pcshaobin.cn/api_content_json/qiche.json'
      },
      {
        category: 'keji',
        title: '科技',
        api: 'https://api.fanppp.cn/Apiaoyou2/xxl/keji'
        // }, {
        //   category: 'lieq',
        //   title: '猎奇',
        //   api: 'https://api.fanppp.cn/Apiaoyou2/xxl/lieq'
      }
    ],
    u = {},
    w = 0,
