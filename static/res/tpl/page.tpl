    ...
    <div class="nav-body">
        ...
        <div id="infobox" class="infobox clearfix">
            ...
            <div id="hot-word" class="hot-word">
                ...
                <div class="word-content allow-drag" id="word-content"></div>
            </div>
        ...
        <% } %>
        <a id="activity-floater" target="_blank" href="https://s.click.taobao.com/fxQuJvu" class="floater" tags='tmall_20211111'><span></span></a>
    </div>
</div>
<!-- 添加快速拨号 -->
